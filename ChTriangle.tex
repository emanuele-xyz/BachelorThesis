...
The color red is written to this \texttt{outColor} variable.
...
In Vulkan we have to specify how color blending works for each framebuffer
attachment
...
We don't use color blending here.
...
We use a \texttt{TODO} struct to configure
the TODO state of the pipeline object we are about to create.
...
TODO: use vkCmdBindPipeline and vkCmdDraw
