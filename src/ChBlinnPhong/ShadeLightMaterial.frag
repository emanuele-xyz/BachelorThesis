...
vec3 diffuse = inLightMaterialDiffuse * (diffuseImpact * inObjectMaterialDiffuse);
...
vec3 specular = inLightMaterialSpecular * (specularImpact * inObjectMaterialSpecular);
